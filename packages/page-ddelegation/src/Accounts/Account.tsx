...
function Account ({ account: { address, meta }, className = '', delegation, filter, isFavorite, proxy, toggleFavorite }: Props): React.ReactElement<Props> | null {
  ...
  return (
    ...
    <tr className={className}>
          ...
          <td className='address'>
            <AddressSmall value={delegation?.accountDelegated}/>
            {isBackupOpen && (
              <Backup
                address={address}
